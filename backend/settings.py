...
# ASGI_APPLICATION = 'backend.asgi.application'  # Deprecated - using WSGI + Socket.io
...
# Cache configuration for rate limiting - Using database cache (no Redis dependency)
CACHES = {
    'default': {
